...
private fun HomePageSorting() {
    ...
    val selectedOption = options.firstOrNull { it.prefValue == selectedSorting }
        ?: options.first { it.prefValue == defaultValue }

    SettingsSelectionDropdown(
        title = "Home page sorting",
        selectedOption = selectedOption,
        options = options,
        optionLabel = HomeSorting::label,
        onOptionSelected = { sorting ->
